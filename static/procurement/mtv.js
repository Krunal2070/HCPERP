...
async function openMtvForm(id) {
    ...
    if (typeof comboboxAutoInit === 'function') comboboxAutoInit(document.getElementById('mtv-form-body'));
...
function _mtvBuildFormHTML(rec, nextNum) {
    ...
    out += '<div class="form-group"><label class="form-label">Transfer Type <span class="req">*</span></label>'
         + '<select class="form-input-styled combo" id="mtvVoucherTypeSelect" ' + dis + ' onchange="mtvOnTypeChange()">'
    ...
    if (!_mtvLocked) {
        out += '<div class="form-group"><label class="form-label">Status</label>'
             + '<select class="form-input-styled combo" id="mtvStatusSel">'
